  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
      <div className="flex min-h-screen">
        ...
        <aside className={`fixed inset-y-0 left-0 z-40 flex w-72 -translate-x-full flex-col bg-[#0b1a33] px-4 py-5 text-slate-300 transition-transform lg:translate-x-0 ${open ? "translate-x-0" : ""}`}>
        ...
        <section className="min-w-0 flex-1 overflow-x-hidden lg:pl-72">
          ...
          <div className="p-5 pb-12 lg:p-8 lg:pb-12"><Outlet /></div>
        </section>
      </div>
    </div>
  );
